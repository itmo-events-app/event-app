...
public class PlaceController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> placeDelete(@Min(value = 5, message = "Параметр id не может быть меньше 5!")
                                            @PathVariable @Parameter(name = "id", description = "ID площадки", example = "5") Integer id) {
